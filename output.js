//Sun Dec 14 2025 17:17:10 GMT+0000 (Coordinated Universal Time)
...
function _0x2f7fc0(_0x377e11, _0x2fb887) {
  try {
    ...
    return console.log("解密失败: " + _0xfa929c.message), null;
  }
}
...
function _0x5cd72f() {
  ...
  return console.log("从环境变量中解析到 " + _0x56f739.length + " 个唯一配置"), _0x56f739;
}
...
async function _0x329888(_0x4aac80) {
  ...
  try {
    ...
    if (_0x3d11b8.success) {
      return console.log("✅ 卡密验证成功"), true;
...
async function _0x4d69d7(_0x44b5a0) {
  try {
    ...
    return console.log("卡密检查失败: " + _0x93dcb5.message), {
      "valid": true,
  ...
  try {
    ...
    if (_0x3c8e82 && _0x3c8e82.success) return console.log("✅ 白名单添加成功: " + _0x588ab1), true;else {
      ...
      if (_0x42c108 && _0x42c108.in_whitelist === true) return console.log("✅ IP已在白名单中（可能是管理员手动添加）: " + _0x588ab1), true;else {
        return console.log("⚠️  IP检查失败，但将继续尝试运行脚本"), console.log("   返回数据: " + JSON.stringify(_0x42c108)), console.log("   提示: 如果后续报错，请联系管理员确认白名单: " + _0x588ab1), true;
      }
    }
  } catch (_0x4b4793) {
    return console.log("❌ 白名单操作异常: " + _0x4b4793.message), false;
  }
}
let _0x46181d = null,
  _0x5088d8 = null;
...
function _0x4b1f7d() {
  ...
  try {
    ...
    return console.log("时间解析失败: " + _0x12f818.message + "，默认允许提现"), true;
  }
}
...
async function _0x1328a9(_0x18fa99, _0x44f2b1) {
  ...
  try {
    ...
    if (_0x277167.success) return console.log("[" + _0x44f2b1 + "] ✓ 提现成功！"), console.log("   金额: " + _0x277167.data.amount + "元"), console.log("   渠道: " + _0x277167.data.providerName), {
      ...
      return console.log("[" + _0x44f2b1 + "] ✗ 提现失败: " + _0x277167.message), {
        "success": false,
        "message": _0x277167.message
      };
    }
  } catch (_0x1571fc) {
    return console.log("[" + _0x44f2b1 + "] ✗ 提现请求失败: " + _0x1571fc.message), {
      "success": false,
  ...
  try {
    ...
    if (_0x45b430 && (_0x342f6a.code === "ECONNREFUSED" || _0x342f6a.code === "ETIMEDOUT" || _0x342f6a.message.includes("Proxy"))) {
      ...
      try {
        ...
        return _0x83db87 && console.log(_0x2841ff + " 直连也失败: " + _0xe8bed0.message), {
          "response": null,
          "body": null
        };
      }
...
class _0x430874 {
    ...
    try {
      ...
      if (_0x25c26e && _0x25c26e.totalCoin) {
        ...
        if (_0x202645 >= this.coinLimit) {
          return console.log(this.getAccountDisplayName() + " 金币已达 " + _0x202645 + "，超过阈值 " + this.coinLimit + "，停止任务"), this.coinExceeded = true, this.stopAllTasks = true, true;
        }
      }
      return false;
    } catch (_0x4e2d50) {
      return console.log(this.getAccountDisplayName() + " 金币检查异常: " + _0x4e2d50.message), false;
    }
  }
  ...
  async ["getAdInfo"](_0x36e32e) {
    try {
      ...
      if (!_0x3844ee) {
        return console.log("[x] " + this.getAccountDisplayName() + " 获取encSign失败"), null;
      }
      ...
      if (!_0x19144b) {
        return console.log("[x] " + this.getAccountDisplayName() + " 广告接口返回为空"), null;
      }
      if (_0x19144b.errorMsg === "OK" && _0x19144b.feeds && _0x19144b.feeds[0] && _0x19144b.feeds[0].ad) {
        const _0x21b5b7 = _0x19144b.feeds[0].exp_tag || "",
      ...
      return console.log("[x] " + this.getAccountDisplayName() + " 获取广告异常: " + _0x33737c.message), null;
    }
  }
  async ["generateSignature"](_0x4a8cd7, _0x9f7087, _0xeeb725, _0x583850) {
    try {
      ...
      return console.log("[x] " + this.getAccountDisplayName() + " 生成签名异常: " + _0x3e4671.message), null;
    }
  }
  async ["getSign"](_0x3579c2) {
    ...
    return console.log("[x] " + this.getAccountDisplayName() + " 所有encsign API都失败了"), null;
  }
  async ["requestSignService"](_0x32720a, _0x4b9387 = "请求签名服务") {
    ...
    for (const _0x4b86b6 of _0x17bacd) {
      try {
        ...
        if (_0x7f667e && _0x7f667e.data) {
          ...
          return Object.assign(_0x41aabc, {
            "__NS_sig3": _0x5147c0,
    ...
    return console.log("[x] " + _0x4b9387 + " 所有nssig API都失败了"), null;
  }
  async ["submitReport"](_0x11f7fd, _0x198ded, _0x5f13f7, _0xc03bfb, _0x19f5d0, _0x397c6c) {
    try {
      ...
      return console.log("[x] " + this.getAccountDisplayName() + " " + _0x397c6c.name + " 奖励失败"), {
        "success": false,
        "reward": 0
      };
    } catch (_0x1b1c8b) {
      return console.log("[x] " + this.getAccountDisplayName() + " 提交任务异常: " + _0x1b1c8b.message), {
        "success": false,
        "reward": 0
      };
    }
  ...
  async ["executeTask"](_0x3f233d) {
    ...
    if (!_0x18352a) {
      return console.log("[x] " + this.getAccountDisplayName() + " 未知任务: " + _0x3f233d), false;
    }
    ...
    try {
      ...
      if (_0x567417?.["success"]) {
        return this.taskStats[_0x3f233d].success++, this.taskStats[_0x3f233d].totalReward += _0x567417.reward || 0, true;
      }
      return this.taskStats[_0x3f233d].failed++, false;
    } catch (_0xec6ae8) {
      return console.log("[x] " + this.getAccountDisplayName() + " 任务异常(" + _0x3f233d + "): " + _0xec6ae8.message), this.taskStats[_0x3f233d].failed++, false;
    }
  }
...
function _0x492041(_0x42d926) {
  ...
  if (_0x514aba.length < 2 || _0x514aba.length > 4) {
    ...
    return console.log(" 账号配置格式错误（需要2-4段）：" + _0x3b873c), null;
  }
  ...
  if (!_0x2ed33b || !_0x18df63) {
    ...
    return console.log(" cookie或salt为空：" + _0x2c3ee6), null;
  }
  let _0x2b209a = null;
...
function _0x59b878() {
  ...
  return _0x1e2e12.forEach((_0x85c2c1, _0x2dfdd4) => {
...
async function _0x595618(_0x1215ce, _0x47f07e, _0x966324) {
  ...
  return await Promise.all(_0x5316d4), _0x1cef69;
}
async function _0x2a6a16(_0x4ee9fe) {
  ...
  return _0x5df52e.printTaskStats(), {
    "index": _0x4ee9fe.index,
    "remark": _0x4ee9fe.remark || "",
    "nickname": _0x1a3fda,
